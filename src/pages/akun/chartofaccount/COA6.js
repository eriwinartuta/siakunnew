...
const ChartOfAccount6 = ({ record, dispatch, useSelector }) => {
  const { coa6bysub5 } = useSelector((state) => state.reducerCOA);
  ...
  const column = [
    {
      ...
      dataIndex: "kode_coa_6",
      key: "kode_coa_6",
      width: 100,
      align: "center",
      render: (text, record, index) => {
        if (record.uraian_coa_6 === null) {
          return <div></div>;
        }
        return (
          <Tag
    ...
    },
    {
      ...
      onFilter: (value, record) => {
        return record.uraian_coa_6.toLowerCase().includes(value.toLowerCase());
      },
      render: (text, record, index) => {
        return (
          <div
          ...
          >
            ...
            <Space> {record.uraian_coa_6} </Space>
          </div>
        );
      },
    },
    ...
    //           }}
    //         />
    //         { record.aktif === 0 ? <Tooltip title="Aktifkan Status">
    //             <Popconfirm
    ...
    //               />
    //             </Popconfirm>
    //           </Tooltip> : <Tooltip title="Non Aktifkan Status">
    //             <Popconfirm
...
export default ChartOfAccount6;
